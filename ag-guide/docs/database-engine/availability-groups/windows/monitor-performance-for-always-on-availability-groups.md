...
##  <a name="BKMK_DATA_SYNC_PROCESS"></a> Data Synchronization Process  
 ...
 ![AlwaysOn Availability Group Data Synchronization](../../../../docs/database-engine/availability-groups/windows/media/always-onag-datasynchronization.gif "AlwaysOn Availability Group Data Synchronization")  
